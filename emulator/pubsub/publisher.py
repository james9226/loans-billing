    ...
    for n in range(1, 1000):
        data = {
            ...
            "mandate": {
                ...
                "sort_code": "090128",
                "agreed_to_dd_mandate": True,
            },
        }

        #     event_id:

        # data = {"key1": "value1", "key2": "value2", "Message Number": n}
        data_str = json.dumps(data)
        # Data must be a bytestring
        # data_encoded = base64.b64encode(data_str.encode("utf-8"))
        data_encoded = data_str.encode("utf-8")
        # When you publish a message, the client returns a future.
        future = publisher.publish(topic_path, data_encoded)
        # print(f"Published data {data_encoded}")
        print(future.result())
